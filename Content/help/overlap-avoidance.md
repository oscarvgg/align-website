...
**Shrinking a block**: When you make a block shorter, other blocks don't automatically move to fill the gap. They stay where they are, creating free time in your schedule.

**Cascading shifts**: When one block shifts and would overlap with another, that block shifts too, creating a chain reaction that keeps your entire schedule organized.

**Example**: You have four consecutive 1-hour blocks from 8:00 AM to 12:00 PM. If you extend the first block by 30 minutes, all three subsequent blocks shift forward by 30 minutes.
...
You can toggle overlap avoidance on or off at any time:

1. Open **Settings**
2. Find **Overlap Avoidance**
3. Toggle the setting **on** or **off**

The change applies immediately to all future actions. Any existing overlaps in your schedule remain as they are—the setting only affects new changes you make.

### Quick Toggle Tip

Some users like to temporarily disable overlap avoidance when making major schedule changes, then re-enable it once everything is roughly in place. This gives you flexibility during planning while maintaining automatic organization during day-to-day use.

## Best Practices

**Keep it on for daily use**: For most people, keeping overlap avoidance enabled makes schedule management faster and less error-prone.
...
**Does overlap avoidance work with all-day events?**  
Overlap avoidance primarily affects timed events. All-day events are displayed separately at the top of your timeline and don't trigger automatic shifting.

**What happens to my existing overlaps if I turn on overlap avoidance?**  
...
**Will turning off overlap avoidance affect my notifications?**  
No, overlap avoidance only affects how time blocks are positioned in your schedule. It doesn't change when or how you receive notifications for your tasks.
